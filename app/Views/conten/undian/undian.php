...
<body id="page-top">
    ...
    <header class="masthead text-white text-center" style="background-color: #F9B208;">
        <div class="container d-flex align-items-center flex-column">
            ...
            <div class="col-lg-12 mb-5 mb-lg-0">
                ...
                foreach ($user as $u) :
                ?>
                    <button <?= cek_stts_hadia($u['id']) ?> onclick="hadia(<?= $u['id']; ?>)" class="btn btn-outline-light mx-2 p-0 m-2 text-center" style="width: 500px; height: 700px;">
                        <img class="ok-download" width="350px" src="<?= base_url() ?>/assets/image/<?= $u['image']; ?>" />
                        <h3>Presiden : <?= $u['nama_presiden'] ?> (<?= $u['nim_presiden'] ?>)</h3>
                        <h5>Wakil : <?= $u['nama_wakil'] ?> (<?= $u['nim_wakil'] ?>)</h5>
                    </button>
            ...
            <!-- Masthead Heading-->
            <h1 class="masthead-heading text-uppercase mb-0 mt-5 pt-5"> UNDIAN NUMBER</h1>
            <!-- Icon Divider-->
    ...
    <!-- Copyright Section-->
    <div class="copyright py-4 text-center text-secondary m-0 p-0" style="background-color: #F98404; font-size: 50px;">
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8" style="background-color: #16697A;">
                                ...
                                <h2 class="portfolio-modal-title  text-uppercase mb-0" style="color: #ffd700;">Mengundi</h2>
                                <!-- Icon Divider-->
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#mengundi').click(function() {
                ...
                $.ajax({
                    type: "get",
                    url: "<?= base_url('GlobalView/get_number') ?>",
                    dataType: "json",
                    success: function(response) {
                        setTimeout(function() {
                            ...
                            $('#pemenang').html(
                                "<h3>Selamat</h3>" +
                                `<h1 style="font-size: 200px;">${response}</h1>` +
                                "" +
                                "");
                            $('#terima').show();
                            nomer = response
            ...
            $('#terima').click(function() {
                $.ajax({
                    type: "post",
                    url: "<?= base_url('GlobalView/save_urutan'); ?>",
                    data: {
                        urutan: nomer,
                        id_user: $('#id_hadia').text(),
                    },
                    dataType: "json",
                    success: function(response) {
