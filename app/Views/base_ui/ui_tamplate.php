...
<head>
    ...
    <!-- Ekko Lightbox -->
    <link rel="stylesheet" href="<?= base_url('tamplate/admin') ?>/plugins/ekko-lightbox/ekko-lightbox.css">
    ...
    <!-- Ekko Lightbox -->
    <script src="<?= base_url('tamplate/admin') ?>/plugins/ekko-lightbox/ekko-lightbox.min.js"></script>
...
<body class="hold-transition  sidebar-mini  sidebar-collapse">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__wobble" src="<?= base_url() ?>/assest/logo/logo.png" alt="AdminLTELogo" height="1000" width="1000">
        </div>
        ...
        <aside class="main-sidebar sidebar-light-primary elevation-4">
            ...
            <div class="brand-link" style="background: white;">
                <img src="<?= base_url() ?>/assest/logo/logo.png" alt="AdminLTE Logo" class="brand-image elevation-3" style="opacity: 10; background: white; border: black;">
                <span class="brand-text font-weight-light" style="color: black; font-style: oblique;">E-Voting</span>
            </div>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image ">
                        <img src="<?= base_url() ?>/assest/logo/logo.png" class="img-circle elevation-2 " alt="User Image">
                    </div>
                    <div class="info">
