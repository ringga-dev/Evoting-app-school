...
<head>
    ...
    <!-- Site favicon -->
    <link rel="apple-touch-icon" sizes="180x180" href="<?= base_url() ?>/assest/logo/logo.png">
    <link rel="icon" type="image/png" sizes="32x32" href="<?= base_url() ?>/assest/logo/logo.png">
    <link rel="icon" type="image/png" sizes="16x16" href="<?= base_url() ?>/assest/logo/logo.png">
...
<body class="hold-transition login-page">
    ...
    <div class="login-box">
        ...
        <p class="card p-0 mt-3">
            ...
            <a href="<?= base_url('auth/register_siswa'); ?>">
                <h5 class="text-right " style="font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; font-style: italic;">Register Siswa</h5>
            </a>

            <a href="<?= base_url('globalView'); ?>">
                <h5 class="text-right " style="font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; font-style: italic;">Undian Nomer Urut</h5>
            </a>

            <a href="<?= base_url('globalView/hasil'); ?>">
                <h5 class="text-right" style="font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; font-style: italic;">Hasil</h5>
            </a>
        </p>
